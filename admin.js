...
function setAdminView(view){const overview=view==="overview",archive=view==="archive",settlement=view==="settlement",orders=view==="orders";document.querySelector("#overviewView").hidden=!overview;document.querySelector("#ordersView").hidden=!orders;document.querySelector("#archiveView").hidden=!archive;document.querySelector("#settlementView").hidden=!settlement;document.querySelector("#overviewViewButton").classList.toggle("is-active",overview);document.querySelector("#ordersViewButton").classList.toggle("is-active",orders);document.querySelector("#archiveViewButton").classList.toggle("is-active",archive);document.querySelector("#settlementViewButton").classList.toggle("is-active",settlement);if(overview)renderOverview();if(archive)renderArchive();if(settlement)renderSettlement();window.scrollTo({top:0,behavior:"smooth"})}
